...
class __Mustache_2c32f8485c7a181ea184ae18f8f59eb4 extends Mustache_Template
{
...
';
        ...
        // 'disabled' section
        $value = $context->find('disabled');
        $buffer .= $this->section5ff316c584e3cc83cff6672eb3967df1($context, $indent, $value);
    ...
    private function section5ff316c584e3cc83cff6672eb3967df1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
