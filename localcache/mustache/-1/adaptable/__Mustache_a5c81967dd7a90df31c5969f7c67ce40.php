...
class __Mustache_a5c81967dd7a90df31c5969f7c67ce40 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section21e73b2188a1cfc31be55ac8ff0ee23c($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function section21e73b2188a1cfc31be55ac8ff0ee23c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '</h6>
';
                $buffer .= $indent . '                    <div class="potentialidplist mt-3">
';
