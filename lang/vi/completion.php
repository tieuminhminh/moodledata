...
$string['activitiescompleted'] = 'Các hoạt động đã hoàn thành';
...
$string['completedunlockedtext'] = 'Khi bạn lưu các thay đổi, trạng thái hoàn thành đối với tất cả học sinh sẽ bị xóa. Nếu bạn đổi ý về điều này, không lưu mẫu đơn lại.';
...
$string['completion-alt-auto-enabled'] = 'Hệ thống xác định phần này đã hoàn thành theo điều kiện đặt ra';
$string['completion-alt-auto-fail'] = 'Đã hoàn thành (không đạt điểm vượt qua)';
$string['completion-alt-auto-n'] = 'Chưa hoàn thành';
$string['completion-alt-auto-pass'] = 'Đã hoàn thành (đạt điểm vượt qua)';
$string['completion-alt-auto-y'] = 'Đã hoàn thành';
$string['completion-alt-manual-enabled'] = 'Học viên có thể tự đánh dấu là đã hoàn thành phần này';
$string['completion-alt-manual-n'] = 'Chưa hoàn thành; hãy chọn đánh dấu chưa hoàn thành';
$string['completion-alt-manual-y'] = 'Đã hoàn thành; hãy chọn đánh dấu hoàn thành';
...
$string['csvdownload'] = 'Tải định dạng bảng (UTF-8 .csv)';
...
$string['enrolmentduration'] = 'Số ngày còn lại';
...
$string['manualcompletionby'] = 'Hoàn thành bằng tay bởi';
...
$string['notenroled'] = 'Bạn chưa ghi danh vào khóa này';
...
$string['usernotenroled'] = 'Người dùng không được ghi danh vào khóa học này';
